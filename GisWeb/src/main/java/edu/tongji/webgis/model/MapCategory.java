...
public class MapCategory {
	...
	private HashMap<String , String> tagToName;
	...
	private MapCategory(){
		...
		map.addTimestamp(new TimeStamp("2015-04-05",1,1));
		map.addTimestamp(new TimeStamp("2015-05-13",2,1));
		maps.add(map);
		...
		map.addTimestamp(new TimeStamp("2020-1-1",1,1));
		//map.addTimestamp(new TimeStamp(Date.valueOf("2012-1-1"),2,1));
		maps.add(map);

		tagToName = new HashMap<>();
		tagToName.put("su", "超市");
		tagToName.put("hos", "医院");
		tagToName.put("rest","饭馆");
	}
	...
	public String addMap(String name, String timestamp){
		...
		map.addTimestamp(new TimeStamp(timestamp,1,1));
		maps.add(map);
		return newMapId;
	}
	...
	public int addTimeStamp(String id, String timestamp){
		...
		map.addTimestamp(new TimeStamp(timestamp,newTs,1));
		return newTs;
	}
}
